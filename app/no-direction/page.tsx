...
export const metadata: Metadata = {
  title: "No Direction",
  description: "Achievement route for regaining clarity and setting your next milestone.",
};

export default function NoDirectionPage() {
  return (
    <main className="min-h-screen px-4 py-10 sm:px-6 lg:px-10">
      <div className="mx-auto flex w-full max-w-3xl flex-col gap-6 rounded-2xl border border-black/10 bg-white/75 p-6 shadow-sm dark:border-white/15 dark:bg-zinc-950/70">
        ...
        <h1 className="font-display text-4xl text-black dark:text-white">No Direction</h1>
        <p className="text-base leading-7 text-black/70 dark:text-white/70">
          This route is designed for moments when priorities feel unclear. Capture what
          matters now and choose the next step that creates momentum.
        </p>
        <Link
          href="/"
